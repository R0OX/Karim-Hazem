                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(item.equals("Student")) {
                                PutData putData = new PutData("http://192.168.1.4/loginRegister/check.php", "POST", check, checkd);//checks if users id exists
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        ...
                                        if (result.equals("Sign up Success")) {
                                            ...
                                            data[3] = item;
                                            PutData ptData = new PutData("http://192.168.1.4/loginRegister/signup.php", "POST", field, data);//send users data
                                            if (ptData.startPut()) {
                                                if (ptData.onComplete()) {
                                                    ...
                                                    if (reult.equals("Sign Up Success")) {
                                                        ...
                                                        datas[0] = "renum";
                                                        PutData putDta = new PutData("http://192.168.1.4/loginRegister/requp.php", "POST", fields, datas);//reorganizes table
                                                        if (putDta.startPut()) {
                                    ...
                                    PutData puData = new PutData("http://192.168.1.4/loginRegister/check2.php", "POST", check, checkd);
                                    if (puData.startPut()) {
                                        if (puData.onComplete()) {
                                            ...
                                            if (result.equals("Sign up Success")) {
                                                ...
                                                data[2] = String.valueOf(email.getText());
                                                data[3] = item;
                                                PutData ptData = new PutData("http://192.168.1.4/loginRegister/signup.php", "POST", field, data);
                                                if (ptData.startPut()) {
                                                    if (ptData.onComplete()) {
                                                        String reult = ptData.getResult();
                                                        if (reult.equals("Sign Up Success")) {
                                                            ...
                                                            String[] datas = new String[1];
                                                            datas[0] = "renum";
                                                            PutData putDta = new PutData("http://192.168.1.4/loginRegister/requp.php", "POST", fields, datas);
                                                            if (putDta.startPut()) {
                                                                if (putDta.onComplete()) {
                                                                    String reut = putDta.getResult();
                                                                }
                                ...
                                PutData puData = new PutData("http://192.168.1.4/loginRegister/check3.php", "POST", check, checkd);
                                if (puData.startPut()) {
                                    if (puData.onComplete()) {
                                        String result = puData.getResult();
                                        if (result.equals("Sign up Success")) {
                                ...
                                PutData puData = new PutData("http://192.168.1.4/loginRegister/check4.php", "POST", check, checkd);
                                if (puData.startPut()) {
                                    if (puData.onComplete()) {
                                        String result = puData.getResult();
                                        if (result.equals("Sign up Success")) {
