    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gobut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PutData ptDta = new PutData("http://192.168.1.4/loginRegister/hallbuild.php", "POST",field,data);//gets halls buildings
                if (ptDta.startPut()) {
                    if (ptDta.onComplete()) {
                ...
                PutData putData = new PutData("http://192.168.1.4/loginRegister/hallava.php", "POST",field,data);//gets halls availability
                if (putData.startPut()) {
                ...
                PutData putDta = new PutData("http://192.168.1.4/loginRegister/errortype.php", "POST",field,data);     //gets the error type of the hall if it existed
                if (putDta.startPut()) {
                ...
                PutData utDta = new PutData("http://192.168.1.4/loginRegister/errordes.php", "POST",field,data);       //gets the error description of the hall if it existed
                if (utDta.startPut()) {
                    if (utDta.onComplete()) {
