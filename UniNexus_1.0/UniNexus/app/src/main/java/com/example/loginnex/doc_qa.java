    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                data[1] = sub;
                PutData putata = new PutData("http://192.168.1.4/loginRegister/qarows.php", "POST", field, data);//gets number of row in the table
                if (putata.startPut()) {
                ...
                PutData ptData = new PutData("http://192.168.1.4/loginRegister/qaname.php", "POST", field, data);//gets the name of the user
                if (ptData.startPut()) {
                ...
                PutData putData = new PutData("http://192.168.1.4/loginRegister/qaphone.php", "POST", field, data);//gets the ID of the  user
                if (putData.startPut()) {
                ...
                PutData puData = new PutData("http://192.168.1.4/loginRegister/qaemail.php", "POST", field, data);//gets the email of the user
                if (puData.startPut()) {
                ...
                PutData puDat = new PutData("http://192.168.1.4/loginRegister/qatitle.php", "POST", field, data);//gets the email of the user
                if (puDat.startPut()) {
                    if (puDat.onComplete()) {
                ...
                PutData utData = new PutData("http://192.168.1.4/loginRegister/qades.php", "POST", field, data);//gets the desupation  of the user
                if (utData.startPut()) {
            ...
            public void onClick(View v) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mail.setData(datas);
                        startActivity(mail);
                        PutData ptData = new PutData("http://192.168.1.4/loginRegister/qaact.php", "POST", field, data);//updates the user permission to 1 to be able to access the app and deletes him from the table
                        if (ptData.startPut()) {
                            if (ptData.onComplete()) {
                                String reult = ptData.getResult();
                        ...
                        PutData putDta = new PutData("http://192.168.1.4/loginRegister/qaup.php", "POST", field, data);//reorganize the table
                        if (putDta.startPut()) {
                        ...
                        PutData pData = new PutData("http://192.168.1.4/loginRegister/qaname.php", "POST", field, data);//gets the name of the user
                        if (pData.startPut()) {
                            if (pData.onComplete()) {
