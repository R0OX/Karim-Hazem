    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                data[0] = "item";
                PutData putata = new PutData("http://192.168.1.4/loginRegister/errows.php", "POST", field, data);//counts the rows in the table
                if (putata.startPut()) {
                ...
                for (int i = 1; i <= max; i++) {
                    ...
                    PutData putdata = new PutData("http://192.168.1.4/loginRegister/errhall.php", "POST", fields, datas);//gets the halls with errors
                    if (putdata.startPut()) {
            ...
            public void onClick(View v) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String[] data = new String[1];
                        data[0] = hal;
                        PutData putDta = new PutData("http://192.168.1.4/loginRegister/errortype.php", "POST",field,data);//gets the error type
                        if (putDta.startPut()) {
                        ...
                        PutData ptDta = new PutData("http://192.168.1.4/loginRegister/errordes.php", "POST",field,data);//gets the error description
                        if (ptDta.startPut()) {
                            if (ptDta.onComplete()) {
                        ...
                        PutData putata = new PutData("http://192.168.1.4/loginRegister/errbuild.php", "POST",field,data);//gets the halls building
                        if (putata.startPut()) {
                            if (putata.onComplete()) {
            ...
            public void onClick(View v) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String[] data = new String[1];
                        data[0] = hal;
                        PutData putDta = new PutData("http://192.168.1.4/loginRegister/errdone.php", "POST",field,data);//delete selected hall from the table
                        if (putDta.startPut()) {
                            if (putDta.onComplete()) {
                                String reslt = putDta.getResult();
                        ...
                        PutData ptDta = new PutData("http://192.168.1.4/loginRegister/errup.php", "POST", field, data);//reorganizes the table
                        if (ptDta.startPut()) {
                            if (ptDta.onComplete()) {
