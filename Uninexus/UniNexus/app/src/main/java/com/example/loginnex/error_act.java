        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connected) {
                    ...
                    data[2] = bild;
                    data[3] = desc;
                    PutData ptData = new PutData("http://192.168.1.35/loginRegister/errorsub.php", "POST", field, data);//send info as a new error to the error table
                    if (ptData.startPut()) {
                    ...
                    PutData ptDta = new PutData("http://192.168.1.35/loginRegister/errup.php", "POST", field, data);//reorganizes the errors table
                    if (ptDta.startPut()) {
                        if (ptDta.onComplete()) {
