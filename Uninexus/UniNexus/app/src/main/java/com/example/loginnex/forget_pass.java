                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(item.equals("Student")){
                                PutData putData = new PutData("http://192.168.1.35/loginRegister/check.php", "POST", check, checkd);//checks if student ID is in the table
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        ...
                                        if (result.equals("Sign up Success")) {
                                            ...
                                            PutData ptData = new PutData("http://192.168.1.35/loginRegister/forget_password.php","POST",field,data);//send user info to the table
                                            if(ptData.startPut()) {
                            ...
                            if(item.equals("Doctor")){
                                PutData putData = new PutData("http://192.168.1.35/loginRegister/check2.php", "POST", check, checkd);//checks if dr ID is in the table
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        String result = putData.getResult();
                                        if (result.equals("Sign up Success")) {
                                            ...
                                            data[0] = String.valueOf(email.getText());
                                            data[1] = String.valueOf(idtext.getText());
                                            PutData ptData = new PutData("http://192.168.1.35/loginRegister/forget_password.php","POST",field,data);
                                            if(ptData.startPut()) {
                                                if(ptData.onComplete()){
                                                    String reult = ptData.getResult();
                                                    if(reult.equals("Request Success")){
                            ...
                            if(item.equals("TA")){
                                PutData putData = new PutData("http://192.168.1.35/loginRegister/check3.php", "POST", check, checkd);//checks if TA ID is in the table
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        String result = putData.getResult();
                                        if (result.equals("Sign up Success")) {
                            ...
                            if(item.equals("Stuff")){
                                PutData putData = new PutData("http://192.168.1.35/loginRegister/check4.php", "POST", check, checkd); //checks if IT ID is in the table
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        String result = putData.getResult();
                                        if (result.equals("Sign up Success")) {
