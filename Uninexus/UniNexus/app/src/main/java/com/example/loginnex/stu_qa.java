        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connected) {
                    ...
                    String num = "";
                    int qanumber=0;
                    PutData putDta = new PutData("http://192.168.1.35/loginRegister/qastart.php", "POST", fields, datas);
                    if (putDta.startPut()) {
                    ...
                    if (!desc.equals("")) {
                        ...
                        PutData ptData = new PutData("http://192.168.1.35/loginRegister/qasubmit.php", "POST", field, data);//send info as a new suggestion to the feedback table
                        if (ptData.startPut()) {
